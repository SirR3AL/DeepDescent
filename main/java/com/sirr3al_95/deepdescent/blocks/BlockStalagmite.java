...
public static final PropertyInteger BLOCK_SIZE= PropertyInteger.create("size", 0, 4);
	...
	public BlockStalagmite(String name, Material material, float hardness, float resistance, int harvestLevel, SoundType sound, String tool) 
	{
    ...
    {
        return state.withProperty(BLOCK_SIZE, Integer.valueOf(checkBelow(worldIn, pos)));
    }
	...
	public int checkBelow(IBlockAccess world, BlockPos pos)
	{
		int i = 0;
